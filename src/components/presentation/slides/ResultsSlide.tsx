    ...
    >
      <div className="grid grid-cols-2 gap-x-16 gap-y-8">
        {SLIDE_13.items.map((item, itemIndex) => (
          <div
            key={itemIndex}
            className="flex items-center gap-8 rounded-[22px] border border-lilac-deep/60 bg-card px-10 py-8"
            style={{ boxShadow: "var(--shadow-card)", minHeight: 132 }}
          >
            <span
              className="flex size-16 shrink-0 items-center justify-center rounded-full bg-crimson text-primary-foreground"
