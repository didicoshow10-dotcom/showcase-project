...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Proposta de Atuação · iCEV" },
      { name: "description", content: "Proposta de atuação para os primeiros 3 meses como Coordenador de Marketing do iCEV." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500;600;700;800&display=swap" },
